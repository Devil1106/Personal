...
public class CIOOcancelinfinalsubmissionverify extends Base {

	 
   public String eCharterID;
   
   @Test
   public void CIOO_Cancel_final_verify() throws InterruptedException, IOException
 {
	   ...
	   //Requestor charter creation//
        ...
        driver.findElement(By.xpath("(//div[@class='p-radiobutton-box'])[1]")).click();
 	    ...
 	    driver.findElement(By.id("projectName")).sendKeys("CIOO verify Cancel in final submit");
