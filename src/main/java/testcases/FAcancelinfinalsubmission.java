...
public class FAcancelinfinalsubmission extends Base {

	 
   public String eCharterID;
   
   @Test
   public void FA_Cancel_final() throws InterruptedException, IOException
 {
	   ...
	   Thread.sleep(1000);
        ...
        driver.findElement(By.xpath("(//div[@class='p-radiobutton-box'])[1]")).click();
 	    ...
 	    driver.findElement(By.id("projectName")).sendKeys("FA Cancel in final submit");
