...
public class PMOcancelinfinalsubmission extends Base {

	 
   public String eCharterID;
   
   @Test
   public void PMO_Cancel_final() throws InterruptedException, IOException
 {
	   ...
	   //Requestor charter creation//
        ...
        driver.findElement(By.xpath("(//div[@class='p-radiobutton-box'])[1]")).click();
 	    ...
 	    driver.findElement(By.id("projectName")).sendKeys("PMO Cancel in final submit");
