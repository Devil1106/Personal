...
public class POcancelincreation extends Base {

	 
   public String eCharterID;
   
   @Test
   public void PO_Cancel_Creation() throws InterruptedException, IOException
 {
	   ...
	   Thread.sleep(1000);
        ...
        driver.findElement(By.xpath("(//div[@class='p-radiobutton-box'])[1]")).click();
 	    ...
 	    driver.findElement(By.id("projectName")).sendKeys("PO Cancel in project creation");
