...
public class testcase5 extends Base {
   ...
   @Test
   public void TS308() throws InterruptedException, IOException
 {
	   ...
	   Thread.sleep(1000);
        ...
        driver.findElement(By.xpath("(//div[@class='p-radiobutton-box'])[1]")).click();
 	    ...
 	    driver.findElement(By.id("projectName")).sendKeys("TS 308");
 ...
 //System 1 added
  ...
  //H-cloud 1//
        driver.findElement(By.xpath("(//span[contains(.,'Add')])[7]")).click();
        driver.findElement(By.id("nameofParticipatingInstitutions")).click();
        driver.findElement(By.xpath("(//div[.='AHPL - ALEXANDRA HEALTH PTE LTD'])[1]")).click();
        driver.findElement(By.id("HCloudTPK")).sendKeys("50");
        driver.findElement(By.id("ShareofHCloudBudget")).sendKeys("1000");
        driver.findElement(By.id("IAARefID")).click();
        driver.findElement(By.xpath("(//div[.='APR110627-1 CHCS                                                                                                '])[1]")).click();
        driver.findElement(By.id("OPEX")).click();
 ...
 //H-cloud 2//
        driver.findElement(By.xpath("(//span[contains(.,'Add')])[7]")).click();
        driver.findElement(By.id("nameofParticipatingInstitutions")).click();
        driver.findElement(By.xpath("(//div[.='AIC - AGENCY FOR INTEGRATED CARE PTE LTD'])[1]")).click();
        driver.findElement(By.id("HCloudTPK")).sendKeys("50");
        driver.findElement(By.id("ShareofHCloudBudget")).sendKeys("1000");
        driver.findElement(By.id("IAARefID")).click();
        driver.findElement(By.xpath("(//div[.='APR110627-1 CHCS                                                                                                '])[1]")).click();
        ...
        driver.findElement(By.id("ProjectCluster")).click();
        driver.findElement(By.xpath("//span[.='AIC']")).click();
        Thread.sleep(1000);
        driver.findElement(By.xpath("(//div[@class='p-checkbox p-component'])[1]")).click();
        driver.findElement(By.xpath("//span[text()='Add']")).click(); 
	    ...
	    driver.findElement(By.id(login.getProperty("domainname"))).sendKeys("healthgrp.com.sg");
	    Thread.sleep(1000);
	    driver.findElement(By.id(login.getProperty("username"))).sendKeys("peter.goh@ihis.com.sg");
	    Thread.sleep(1000);
	    driver.findElement(By.id(login.getProperty("password"))).sendKeys("eCharter123");
	    Thread.sleep(1000);
	    driver.findElement(By.xpath(login.getProperty("login"))).click();
