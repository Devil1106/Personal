...
public class CIOOcancelinfinalsubmission extends Base {

	 
   public String eCharterID;
   
   @Test
   public void CIOO_Cancel_final() throws InterruptedException, IOException
 {
	   ...
	   Thread.sleep(1000);
 	   ...
 	   driver.findElement(By.xpath(login.getProperty("login"))).click();
 	    ...
 	    WebElement radio2 = driver.findElement(By.xpath("(//div[@class='p-radiobutton-box'])[1]"));
        ...
        radio2.click();
 	    ...
 	    driver.findElement(By.id("projectName")).sendKeys("CIOO Cancel in final submit");
        ...
        driver.findElement(By.xpath("(//input[@id='navigators'])[2]")).sendKeys("12/2022");
          ...
          String SAPID = "k-kk-kk-kkkk-kk";
          driver.findElement(By.xpath("//input[@id='SapId']")).sendKeys(SAPID);
        ...
        driver.findElement(By.xpath("(//input[contains(@type,'text')])[27]")).sendKeys("05/2022");
        driver.findElement(By.xpath("(//input[contains(@type,'text')])[28]")).sendKeys("12/2022");
        ...
        Thread.sleep(1000);
        driver.findElement(By.xpath("(//div[@class='p-radiobutton-box'])[1]")).click();
        driver.findElement(By.xpath("//span[text()='Add']")).click(); 
        ...
        Thread.sleep(1000);
        driver.findElement(By.xpath("//input[@placeholder='Search']")).sendKeys("manish");
        driver.findElement(By.xpath("(//div[@class='p-radiobutton-box'])[1]")).click();
        driver.findElement(By.xpath("//span[text()='Add']")).click(); 
 ...
 // RO approval//
 	    ...
 	    driver.findElement(By.id(login.getProperty("domainname"))).sendKeys("healthgrp.com.sg");
 	    Thread.sleep(1000);
 	    driver.findElement(By.id(login.getProperty("username"))).sendKeys("MANISH.SHARMA@IHIS.COM.SG");
 	    Thread.sleep(1000);
 	    driver.findElement(By.id(login.getProperty("password"))).sendKeys("eCharter123");
 	    Thread.sleep(1000);
 	    driver.findElement(By.xpath(login.getProperty("login"))).click();
...
// CIOO Amendment //
 	    ...
 	    driver.findElement(By.id(login.getProperty("domainname"))).sendKeys("healthgrp.com.sg");
 	    Thread.sleep(1000);
 	    driver.findElement(By.id(login.getProperty("username"))).sendKeys("cheong.kok.leong@ihis.com.sg");
 	    Thread.sleep(1000);
 	    driver.findElement(By.id(login.getProperty("password"))).sendKeys("eCharter123");
 	    Thread.sleep(1000);
 	    driver.findElement(By.xpath(login.getProperty("login"))).click();
	    ...
	    driver.findElement(By.xpath("(//i[@class='fa fa-check-circle-o ng-star-inserted'])[1]")).click();
	    Thread.sleep(5000);
	    driver.findElement(By.xpath("//span[.='Request For Amendment']")).click();
	    Thread.sleep(1000);
...
//Requestor initiate Cancel//
 	    
 	    
 	    if (SAPID == "k-kk-kk-kkkk-kk") { 
	    ...
	    driver.findElement(By.xpath("(//i[@class='fa fa-check-circle-o ng-star-inserted'])[1]")).click();
	    Thread.sleep(3000);
	    driver.findElement(By.xpath("//span[.='Submit for Cancellation']")).click();
	    Thread.sleep(1000);
	    driver.findElement(By.xpath("(//textarea[@rows='4'])[1]")).sendKeys("Test kk");
	    Thread.sleep(1000);
	    driver.findElement(By.xpath("//input[@type='file']")).sendKeys("C:\\Users\\Admin\\Downloads\\Priyanka- Resume.pdf");
	    Thread.sleep(1000);
	    driver.findElement(By.xpath("//span[.='Upload Document']")).click();
	    Thread.sleep(2000);
	    try {
...
// PMO complete cancellation //
	    ...
	    driver.findElement(By.xpath("(//i[@class='fa fa-check-circle-o ng-star-inserted'])[1]")).click();
	    Thread.sleep(5000);
	    driver.findElement(By.xpath("//span[.='Complete Cancellation']")).click();
	    Thread.sleep(1000);
	    driver.findElement(By.xpath("(//textarea[@rows='4'])[1]")).sendKeys("Test");
	    Thread.sleep(1000);
	    driver.findElement(By.xpath("//input[@type='file']")).sendKeys("C:\\Users\\Admin\\Downloads\\Priyanka- Resume.pdf");
